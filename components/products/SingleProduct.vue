              ...
              <div class="all-detail-div">
                ...
                <div class="air-line-div">
                  ...
                  <div class="abc-div">
                    ...
                    >
                    <span
                      class="proxima_regular color-hover viw-list"
                      @click="
                        () => this.$router.push('/cms/airline-carry-on-guide')
                      "
                      >view list</span
                    >
                  </div>
                  ...
                  >
                    ...
                    <div class="info-colpse" v-if="showProductDetail">
                      ...
                      <div class="warnty-return">
                        <a
                          href="#"
                          @click.prevent="showModalPopUp = !showModalPopUp"
                        ...
                        <div class="weight-capcity">
                          ...
                          >
                            ...
                            >
                              <p
                                class="proxima_regular"
                                v-if="lapIndex != 'Tumi Laptop Size Desc'"
                              >
                                {{ lapIndex }}
                              </p>
                              <p class="proxima_regular">{{ lapItem }}</p>
                            </div>
                          </template>
...
.design-inovoation .tm-title__h h3 {
  font-size: 20px;
}
</style>
